...
namespace D_real_social_app.Controllers
{
    public class PostController : Controller
    {
        ...
        public PostController(SocialAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PostID,UserID,Text,Photo")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostID,UserID,Text,Photo")] Post post)
        {
            if (id != post.PostID)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SocialAppContext.Post'  is null.");
            }
            var post = await _context.Post.FindAsync(id);
            if (post != null)
            {
